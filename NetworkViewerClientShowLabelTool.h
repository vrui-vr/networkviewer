...
#ifndef NETWORKVIEWERCLIENTSHOWLABELTOOL_INCLUDED
#define NETWORKVIEWERCLIENTSHOWLABELTOOL_INCLUDED
...
/**************************************************************
Declaration of class CollaborativeNetworkViewer::ShowLabelTool:
**************************************************************/

class CollaborativeNetworkViewer::ShowLabelTool:public CollaborativeNetworkViewer::Tool
	{
	/* Embedded classes: */
	private:
	typedef Vrui::GenericToolFactory<ShowLabelTool> Factory; // Factory class for this tool class
	friend class Vrui::GenericToolFactory<ShowLabelTool>;
	...
	ShowLabelTool(const Vrui::ToolFactory* factory,const Vrui::ToolInputAssignment& inputAssignment);
