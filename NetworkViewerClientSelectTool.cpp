...
/***************************************************************
Static elements of class CollaborativeNetworkViewer::SelectTool:
***************************************************************/

CollaborativeNetworkViewer::SelectTool::Factory* CollaborativeNetworkViewer::SelectTool::factory=0;

/*******************************************************
Methods of class CollaborativeNetworkViewer::SelectTool:
*******************************************************/

void CollaborativeNetworkViewer::SelectTool::initClass(void)
	{
	/* Create a factory object for the custom tool class: */
	factory=new Factory("SelectTool","Select Nodes",Tool::factory,*Vrui::getToolManager());
...
CollaborativeNetworkViewer::SelectTool::SelectTool(const Vrui::ToolFactory* factory,const Vrui::ToolInputAssignment& inputAssignment)
	:Tool(factory,inputAssignment)
	{
	}

const Vrui::ToolFactory* CollaborativeNetworkViewer::SelectTool::getFactory(void) const
	{
	return factory;
	}

void CollaborativeNetworkViewer::SelectTool::buttonCallback(int buttonSlotIndex,Vrui::InputDevice::ButtonCallbackData* cbData)
	{
	...
	if(cbData->newButtonState) // Button has just been pressed
		...
		if(pickedNodeIndex!=~0x0U)
			...
			application->nvClient->selectNode(pickedNodeIndex,0);
			}
		}
	}
