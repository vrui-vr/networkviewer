...
/************************************
Methods of class RenderingParameters:
************************************/

RenderingParameters::RenderingParameters(void)
	:nodeRadius(0.05),useNodeSize(1U),nodeSizeExponent(1.0/3.0),
	 linkLineWidth(1.0),linkOpacity(0.1)
	{
	}
